...
(when (> emacs-major-version 23)
  ...
  ;; refresh package contents on first run ie elpa folder is missing
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(rjsx-mode base16-theme markdown-mode magit yaml-mode rainbow-mode pug-mode fill-column-indicator delight general-close which-key company-irony irony helm persp-mode spaceline window-numbering company-tern company-c-headers company js2-mode yasnippet web-mode typing iedit expand-region emmet-mode 2048-game))))
(custom-set-faces
